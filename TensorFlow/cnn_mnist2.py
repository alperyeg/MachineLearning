...
def conv_net(x):
    ...
    Returns:
      ...
      values equal to the logits of classifying the digit into one of
      10 classes (the digits 0-9). keep_prob is a scalar placeholder for
      the probability of dropout.
    """
    # Reshape to use within a convolutional neural net.
    # Last dimension is for "features" - there is only one here, since
    # images are grayscale -- it would be 3 for an RGB image, 4 for RGBA, etc.
    ...
    # Pooling layer - downsamples by 2x2
    ...
    # Second pooling layer, size will be reduced to 7x7
    ...
    # Map the 1024 features to 10 classes, one for each digit; one layer
    # softmax regression
