"""
Pytorch Reinforcment Learning tutorial, follows:
...
def select_action(s):
    """
    Will select an action accordingly to an epsilon greedy policy. Simply put,
    we’ll sometimes use our model for choosing the action, and sometimes
    we’ll just sample one uniformly.
...
if __name__ == '__main__':
    ...
    plt.ion()
    # A single transition in the environment. It essentially maps
    # (state, action) pairs to their (next_state, reward) result, with the
    # state being the screen difference image.
    ...
    # returned from AI gym. Typical dimensions at this point are close
    # to 3x40x90
    # which is the result of a clamped and down-scaled render buffer
    # in get_screen()
    ...
    print(f'Actions from gym env space {n_actions}')
    ...
    for i_episode in range(num_episodes):
        ...
        print(f'Env reset observations:\n {observation}')
